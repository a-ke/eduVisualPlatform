<template>
    <div class="teachingBorderFrame">
        <div class="teachingBorderFrame-head">
...
.teachingBorderFrame {
  ...
  .teachingBorderFrame-head {
    ...
    .titleName {
      ...
      .titleName_l {
        background: url("../../../static/images/public/titleName_l.png")
          no-repeat;
        background-size: 100% 100%;
      }
      .titleName_r {
        background: url("../../../static/images/public/titleName_r.png")
          no-repeat;
        background-size: 100% 100%;
      }
      .titleName_m {
    ...
    .more {
      float: right;
      background: url("../../../static/images/public/moreBtn.png") no-repeat
        center;
      background-size: 100%;
      height: 0.33rem;
      line-height: 0.32rem;
